...
public class VizitkaController {
    private final List<Vizitka> seznamVizitek=List.of(
            ...
            new Vizitka("Barbora Bühnová", "Czechitas z. s.", "Sokolovská 139/320", "Praha 9, 190 00","","+420 294 367 948", "www.czechitas.cz"),
            ...
            new Vizitka("Mirka Zatloukalová", "Czechitas z. s.", "Klímova 2127/4", "Brno-Žabovřesky, 616 00","mirka@czechitas.cs","", "www.czechitas.cz")
    );
